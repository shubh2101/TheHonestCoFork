...
const Filter = [
  {
    ...
    logo: 'react.svg',
    description:
      'Unlock seamless global transactions with our expert mobile app development. Explore the role of remittance applications in business expansion.',
...

  {
    ...
    logo: 'react.svg',
    description:
      'Empower your trading with AI and ML. Explore our crypto trading bot for intelligent and automated strategies in the dynamic market.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Transform agriculture with AI and ML. Detect plant diseases early for sustainable farming. Explore our cutting-edge solutions.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Revolutionize your online presence with low-code platforms. Simplify e-commerce store creation and enhance customer engagement.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Optimize business strategy with AI and ML solutions. Enhance forecasting and customer targeting for sustainable and impactful growth.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      "Experience comprehensive pre-school mobile app. Ensure secure parental tracking and smooth transits. Elevate your child's learning journey.",
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Transform education with adaptive course modules powered by deep learning algorithms. Tailor learning experiences for enhanced outcomes.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Simplify contract management with custom app development. Explore automated solutions for seamless and efficient contract processes.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Modernize interview scheduling with mobile apps. Enhance team efficiency and applicant experience. Elevate your recruitment process.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Optimize HR operations with machine learning models. Streamline application filterization and shortlisting for efficient and effective hiring.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Boost e-commerce efficiency with custom CRM development. Tailored solutions for enhanced customer relationship management and business growth.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Enhance route planning and fleet management with artificial intelligence. Optimize operations for efficient and cost-effective logistics.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'In the Middle East, the healthcare sector is witnessing a pivotal transformation, driven by the rapid adoption of digital technologies.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Adopting cultural sensitivity within healthcare technology ensuring meaningful and effective healthcare solutions for Middle Eastern businesses',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Advanced patient relationship management (PRM) softwares streamlining payments benefiitng both healthcare providers and patients.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Role of mobile application in providing continious support and care for individual seeking mental health support & services.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'A digital revolution is surging through the BFSI sector, fuelled by ever-evolving customer demands and a thirst for innovation.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'By integrating AI into application development, BFSI companies are unlocking doors to a future of unprecedented efficiency, agility, and customer-eccentricity.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      "Today's savvy customers expect personalized experiences, and businesses need custom software solutions that address their unique challenges and unlock new opportunities.",
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'The BFSI landscape is undergoing a radical transformation driven by evolving customer expectations, disruptive technologies, and a relentless pursuit of efficiency and compliance. ',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      "In today's job market, finding the right talent is vital for success. But traditional hiring methods can be slow and ineffective, costing time and money. ",
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      "Today's competitive job market demands trust and security for successful hiring. As an IT decision-maker in staffing tech, leveraging innovative solutions is key to enhancing both. ",
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'In the dynamic field of staffing and recruitment, swift talent discovery is vital. Video interviewing platforms are revolutionizing candidate assessment, offering a new approach for organizations. ',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      "Amidst today's fast-paced business environment, organizations continually pursue streamlined hiring processes and efficient talent identification. ",
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      ' Within the dynamic realm of recruitment, the quest for top talent is an ongoing endeavor that shapes the success of organizations.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Student Information Systems, commonly known as SIS, are comprehensive platforms designed to streamline administrative tasks, manage student data, and provide valuable insights to educational institutions.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      "In today's rapidly evolving educational landscape, the traditional classroom model is being complemented, and in some cases supplanted, by dynamic virtual learning environments.",
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Subscription Management & Accountancy Solutions offer comprehensive platforms designed to simplify financial management, automate subscription billing, and provide real-time insights into financial performance.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'In the digital era of education, institutions, educators, and students are embarking on a transformative journey, leveraging technology to enrich learning experiences and boost overall efficiency.',
  ...
  },
  {
    ...
    logo: 'react.svg',
    description:
      'Every student is unique, with their own set of strengths, weaknesses, and learning preferences. Adaptive learning platforms empower educators to provide differentiated instruction that caters to the individual needs of each student.',
  ...
  },
  {
    id: 31,
    image: Article31,
    name: 'Empowering Patient Knowledge via PRM softwares',
    category: 'tab2',
    logo: 'react.svg',
    description:
